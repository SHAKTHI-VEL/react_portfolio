...
function Skills() {
  ...
  return (
    ...
    <div className='mx-4 bg-[#EAF6F6]  h-100 mt-8  md:h-[70%] lg:rounded-3xl'  >
        ...
        <div className='w-[20%] ml-[3%] md:w-[10%] ml-[11%] mt-5 ' data-aos="fade-up"  data-aos-delay="100">
        <img src={require('../assets/cplus.png')} alt=""/>
        </div>
        <div className='w-[20%] ml-[10%] md:w-[10%] ml-[1%] mt-5' data-aos="fade-up"  data-aos-delay="100">
        <img src={require('../assets/react.png')} alt=""/>
        </div>
        <div className='w-[20%] ml-[10%] md:w-[10%] ml-[1%] mt-5' data-aos="fade-up"  data-aos-delay="100">
        <img src={require('../assets/github.png')} alt=""/>
        </div>
        <div className='w-[20%] mr-2  md:w-[10%]  mt-5 mr-32' data-aos="fade-up"  data-aos-delay="100">
